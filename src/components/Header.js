        ...
        <header>
          ...
          >
            ...
            <li>
              <ul className="social">
                <li>
                  <a href="google" className="icons-sm fb-ic">
                    <i className="fa fa-facebook"> </i>
                  </a>
                </li>
                <li>
                  <a href="google" className="icons-sm pin-ic">
                    <i className="fa fa-pinterest"> </i>
                  </a>
                </li>
                <li>
                  <a href="google" className="icons-sm gplus-ic">
                    <i className="fa fa-google-plus"> </i>
                  </a>
                </li>
                <li>
                  <a href="google" className="icons-sm tw-ic">
