        ...
        <div className="container-fluid">
          <div className="row">
            ...
            <div className="col-lg-2">
              ...
              <ul>
                <li>
                  <a href="google">Store Delivery</a>
                </li>
                <li>
                  <a href="google">Online Delivery</a>
                </li>
                <li>
                  <a href="google">Delivery Terms &amp; Conditions</a>
                </li>
                <li>
                  <a href="google">Tracking</a>
                </li>
              </ul>
            </div>
            <div className="col-lg-2">
              ...
              <ul>
                ...
                <li>
                  <a href="google">Return Policy</a>
                </li>
                <li>
                  <a href="google">Product Registration</a>
                </li>
              </ul>
            </div>
